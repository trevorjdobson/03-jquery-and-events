...
articleView.handleMainNav = function() {
  $('.main-nav').on('click', '.tab', function(){
    ...
    console.log(this);
    //$(`.tab-content[data-content="${$(this).val()}"]`).fadeIn();

    //We need to hide all the sections then fadeIn the clicked section
...
articleView.setTeasers = function() {
  ...
  $('article').on('click', 'a.read-on', function(e){
    e.preventDefault();
    $(this).parent().addClass('clicked-readon');
    $('.clicked-readon .article-body *:nth-of-type(n+2)').fadeIn();
  })
};
